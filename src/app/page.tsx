        ...
        <div className={styles.fullPageWrapper}>
          ...
          <section className={styles.socialMediaSection}>
            ...
            <div className={styles.socialMediaLinks}>
              <a href="https://open.spotify.com/show/5ucZpdw230SJCQilS3yJ8H" target="_blank" rel="noopener noreferrer" className={styles.socialLink} title='Spotify playlist'>
                <FaSpotify size={30} className={styles.icon} /> Spotify
              </a>
              <a href="https://www.youtube.com/@MikaelJaMikker" target="_blank" rel="noopener noreferrer" className={styles.socialLink} title='Youtube kanal'>
          ...
          <footer className={styles.footer}>
            <p>&copy; {new Date().getFullYear()} Mikael Meema - Kõik õigused kaitstud
              <br />
              Veebilehe tegi: <a className={styles.footerMail} title='Veebilehe autori e-maili aadress' href="mailto:info@digiarendus.ee"> info@digiarendus.ee</a>
            </p>
          </footer>
        </div>
      </div>
